...
class CompositeBridgeGenerator:
    def __init__(
        ...
        self.link_tables: Dict[str, pd.DataFrame] = {}  # the link tables generated by this class
    ...
    def _create_link_tables(self):
        ...
        while unprocessed_tables:
            ...
            if multi_column:
                ...
                self.link_tables[composite_table_name] = current_table
        ...
        for composite_table_name in self.link_tables:
        ...
        for table_name, table_data in self.tables.items():
            for columns in self.column_combinations:
                ...
                if all(col in table_data.columns for col in columns):
                    ...
                    # Remove the original shared columns only from non-link tables
                    if table_name not in self.link_tables:
                        self.tables[table_name] = self.tables[table_name].drop(columns=columns)
